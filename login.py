...
def registro_nuevo(root, lista_jugadores):
    ...
    usuario_nuevo = Label(registro_usuario, text = 'Nuevo usuario:', bg = 'white', fg = '#6585c2', justify = "left", font = ("Lucida Console", 15))
    usuario_nuevo.place(x = 75, y = 170)
    input_usuario = Entry(registro_usuario, textvariable = usuario, bg = "white", fg = "#f29434", justify = "left", font = ("Lucida Console", 15))
    input_usuario.place(x = 75, y = 200, width = 250, height = 30)

    clave_nueva = Label(registro_usuario, text = 'Nueva clave:', bg = 'white', fg = '#6585c2', justify = "left", font = ("Lucida Console", 15))
    clave_nueva.place(x = 75, y = 250)
    input_clave = Entry(registro_usuario, textvariable = clave, bg = "white", fg = "#f29434", justify = "left", font = ("Lucida Console", 15))
    input_clave.place(x = 75, y = 280, width = 250, height = 30)
    input_clave.config(show = '*')

    confirmacion_clave = Label(registro_usuario, text = 'Confirmar clave:', bg = 'white', fg = '#6585c2', justify = "left", font = ("Lucida Console", 15))
    confirmacion_clave.place(x = 75, y = 330)
    input_confirmacion_clave = Entry(registro_usuario, textvariable = confirmar_clave, bg = "white", fg = "#f29434", justify = "left", font = ("Lucida Console", 15))
